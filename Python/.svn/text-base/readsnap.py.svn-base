...
def read_block(filename, block, parttype=-1, physical_velocities=True, arepo=0):
  ...
  if block=="POS ":
    ...
    data_for_type[0] = True
    block_num = 8+blockadd
  elif block=="NH  ":
    data_for_type[0] = True
    block_num = 9+blockadd
  elif block=="HSML":
    data_for_type[0] = True
    block_num = 10+blockadd
  elif block=="SFR ":
    data_for_type[0] = True
    block_num = 11+blockadd
  elif block=="AGE ":
    data_for_type[4] = True
    block_num = 12+blockadd
  elif block=="Z   ":
    data_for_type[0] = True
    data_for_type[4] = True
    block_num = 13+blockadd
  elif block=="BHMA":
    data_for_type[5] = True
    block_num = 14+blockadd
  elif block=="BHMD":
    data_for_type[5] = True
    block_num = 15+blockadd
  else:
